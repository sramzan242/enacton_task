...
import Recipies from "./components/page3/Recipies";
        ...
        <div className="flex flex-col flex-grow">
          {!isNavOpen && (
            <div className="w-[8vw] h-screen p-10 absolute z-10 bg-black opacity-80 border-r-4 border-[#ea9534]">
              <button
                className="text-3xl ml-2 mt-5 text-white"
                onClick={toggleNav}
              >
                &#9776;
              </button>
              <div className="flex items-center justify-center flex-col mt-80">
                <div className="-rotate-90 w-60">
                  <img
                    ...
                    src="\images\WhatsApp_Image_2024-07-09_at_16.23.39_d59e32f2-removebg-preview.png"
                    alt=""
                  />
                </div>
              </div>
